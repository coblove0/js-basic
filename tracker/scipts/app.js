...
function togglePopup() {
  const coverHiddenClass = 'cover_hidden';
  if (page.popup.index.classList.contains(coverHiddenClass)) {
    page.popup.index.classList.remove(coverHiddenClass);
  } else {
    page.popup.index.classList.add(coverHiddenClass);
  }
}
